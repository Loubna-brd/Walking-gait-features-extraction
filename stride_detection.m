function [stepping_period_accel_filt,stepping_period_time_filt,stepping_period_duration_filt,stepping_period_resting_duration_filt,loc_peak,peak_value,time_peak,section_beg,section_end,hr_stepping_period_filt,time_hr_stepping_period_filt] = stride_detection(stepping_period_accel,stepping_period_time,stepping_period_duration,stepping_period_resting_duration,hr_stepping_period,time_hr_stepping_period,min_peak_height,min_peak_distance,min_peak_prominence,window_movmean)
...
%   detected
%   - stepping_period_resting_duration_filt: amount of resting (e.g. standing
%   within a stepping period with peaks detected
...
stepping_period_resting_duration_filt = stepping_period_resting_duration;
...
stepping_period_resting_duration_filt(l_k) = [];
